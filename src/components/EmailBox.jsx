  ...
  return (
    <>
      <div className="w-full pb-10">
        <div className="bg-[#cbded2] max-w-7xl mx-auto">
          <div className="grid grid-cols-2 gap-2 p-4 justify-center ">
            <div className="items-center justify-center pl-20">
              <h3 className="font-bold text-slate-700">
                Sign up and join the Port of Mokha family
              </h3>
              <p className="text-slate-700">
                Receive early access to special coffee offerings, discounts on
                the stuff you love, and updates on our coffee adventures.
              </p>
            </div>
